...
// Centered no matter what else is on the page. The site middleware can append a docs block after
// <main>; a row-flex body would then shove the card to the left. `flex-direction:column` + centered
// alignment + `margin:auto` on the card keep the card centered horizontally and vertically, and
// text-align:center centers its contents — a real squeeze page, centered.
const BASE_CSS = `*{box-sizing:border-box}body{margin:0;font:16px/1.55 -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;background:#f6f5f1;color:#1a1a1a;min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:24px}main{background:#fff;border:1px solid #e3e1da;border-radius:16px;padding:36px 32px;max-width:460px;width:100%;margin:auto;box-shadow:0 10px 40px rgba(0,0,0,.08)}h1{font-size:25px;margin:0 0 12px;line-height:1.2}p{margin:0 0 16px;color:#444}.btn{display:inline-block;background:#111;color:#fff;text-decoration:none;padding:15px 26px;border-radius:12px;font-weight:600;font-size:17px;border:0;cursor:pointer;width:100%;max-width:320px}.btn:hover{background:#000}.btn.alt{background:#fff;color:#111;border:1px solid #111}.foot{display:block;margin-top:24px;color:#999;font-size:11px;font-family:ui-monospace,Menlo,monospace;word-break:break-all}.tag{display:inline-block;font:600 11px/1 ui-monospace,Menlo,monospace;letter-spacing:.08em;text-transform:uppercase;color:#666;border:1px solid #e3e1da;border-radius:999px;padding:6px 11px;margin-bottom:16px}img.media{max-width:100%;border-radius:12px;margin:0 0 18px}.muted{color:#888;font-size:14px}`;

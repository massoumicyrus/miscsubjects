import {
  CODING_LAW_OBJECT,
  codingLawMarkdown,
  codingLawSkillMarkdown,
} from "../../../_lib/coding_law_object.js";
...
export async function onRequestGet({ request, env }) {
  ...
  if (format === "markdown" || format === "md") {
    return new Response(codingLawMarkdown(), {
      headers: {
  ...
  const envelope = await articleObjectEnvelope(
    ...
    {
      slug: "coding-law",
      title: CODING_LAW_OBJECT.identity.title,
      body: CODING_LAW_OBJECT.content.thesis,

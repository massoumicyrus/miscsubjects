-- Force the ROUTER to call tools for anything about the build (kills generic-Grok answers).
...
- how many tools / what can you do / what models can you call → [DIR_LIST][/DIR_LIST], then count/answer from the real rows

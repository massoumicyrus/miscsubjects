...
INSERT INTO directory_tests (key, kind, args, expect_kind, expect_value, note) VALUES
  ...
  ('SHA256_LOWER',           'positive', '[OWNER_EMAIL]',                                 'contains',   'eb1f08c6688d1cf35a2dbd24b29452893bcce8ba01e2614685f69a6da0a500c4', 'known hash'),
  ...
  ('CF_PAGES_LIST',          'positive', '<CLOUDFLARE_ACCOUNT_ID>',              'contains',   'loop-safe-miscsubjects',                       ''),

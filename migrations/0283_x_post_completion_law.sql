...
VALUES (
  ...
  'models repeatedly re-asked after an explicit social drop, hid two real X URLs, and substituted invented dedupe narration',
...
VALUES (
  ...
  'web models repeatedly selected Bash despite the browser lane and falsely diagnosed the build from shell DNS failures',

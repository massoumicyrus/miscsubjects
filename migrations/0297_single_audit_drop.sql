-- Owner correction 2026-07-21: one public audit DROP must make an outside model
-- answer the technical significance, not return a feature inventory or bury the
-- strongest finding as a footnote.

DELETE FROM directory_tests
WHERE kind='e2e' AND note='owner correction 2026-07-21: one audit drop must force the meaning, benefit and edge';
...
VALUES (
  ...
  'owner correction 2026-07-21: one audit drop must force the meaning, benefit and edge',

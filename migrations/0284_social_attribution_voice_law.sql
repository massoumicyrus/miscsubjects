...
VALUES (
  ...
  'models posted as the owner in first person and repeated boring breathless slogans instead of signing the execution surface/model/time and leading with evidence',
...
VALUES (
  ...
  'Grok ignored the live X_POST capability and falsely treated its lack of a personal X account/provider key as a blocker',
...
VALUES (
  ...
  'the social token was narrowed to three rows and Grok lost the previously working ability to operate the build before posting',
...
VALUES (
  ...
  'models reduced the ecosystem to an auditing/social-post contract instead of doing useful site work and proving it before publication',

...
-- That table was migrated away; the live ledger is the events table in loop-shared-events,
-- read via LEDGER_QUERY (D1_QUERY targets loop-content-spine, which has no events table).

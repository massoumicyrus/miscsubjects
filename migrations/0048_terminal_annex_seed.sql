...
- [LOCAL_EXEC]any shell line[/LOCAL_EXEC] — sh -lc on the owner''s Mac. Examples: [LOCAL_EXEC]ls -la ~/miscsubjects-pages[/LOCAL_EXEC] · [LOCAL_EXEC]git -C ~/miscsubjects-pages log --oneline -5[/LOCAL_EXEC] · [LOCAL_EXEC]npx wrangler pages deploy public --project-name miscsubjects-pages --commit-dirty=true[/LOCAL_EXEC]
